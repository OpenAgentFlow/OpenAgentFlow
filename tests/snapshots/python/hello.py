...
def greeter_node(state: WorkflowState) -> WorkflowState:
    ...
    print(f'[Greeter] Running agent (model="gemma-4-26b-a4b-it", provider={getattr(llm, "_oaf_provider", "unknown")})')

    system_prompt = """Say hello to the user."""

    user_message = json.dumps({k: v for k, v in state.items() if v is not None})
...
if __name__ == "__main__":
    ...
    print(f"Running workflow: Hello")
    print(f"{'-' * 50}")
